...
## Separation of Work Assignment 7c4

| Developpers | Work| 
| --------------------| :--------------------: | 
|   Nour Elhouda Benaida    |                     HTML/M/V/test-data/ of Klass <br> Logo creation<br> Firestore_rules   | 
|   Elias George            |                     HTML/M/V/test-data/ of Person and MembershipOptions<br>               | 
